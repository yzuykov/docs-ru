...
\n\
            ...
            if (modal.modeCheckbox.checked) {\n\
                ...
                debugger;\n\
//                // 1. check .mw exists\n\
//                var mw_check_url = \'https://raw.github.com/\' + github.user + \'/\' + github.repo + \'/\' + github.branch + \'/\' + names.mwFileName,\n\
//                    mw_exists;\n\
//                $.ajax({url:mw_check_url, type:\'HEAD\', async:0})\n\
//                    .done(function() { mw_exists = true; })\n\
//                    .fail(function() { mw_exists = false; });\n\
                var mw_exists = true;\n\
                \n\
                // 2. write .html\n\
                repo.write(github.branch, names.fileName, mw_html, \'---\', function(err) {\n\
                    if (err) console.log(err);\n\
                        ...
                        // 3. delete .mw.html\n\
                        setTimeout(function() {\n\
                            repo.remove(github.branch, names.mwFileName, function(err) {\n\
                                if (err) {\n\
                                    setTimeout(function() {\n\
                                        repo.remove(github.branch, names.mwFileName, function(err) {\n\
                                            if (err)\n\
